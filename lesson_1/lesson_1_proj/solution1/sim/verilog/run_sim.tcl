...
if {[file isfile simple_adder.autotvin.dat]} {
	file delete -force simple_adder.autotvin.dat
}

if {[file isfile simple_adder.autotvout.dat]} {
	file delete -force simple_adder.autotvout.dat
}
