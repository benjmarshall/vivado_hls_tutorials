...
HD_PWD='/mnt/centos_share/Vivado_Tutorials/vivado_hls_tutorials/lesson_1/lesson_1_proj/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_adder.tcl -notrace
