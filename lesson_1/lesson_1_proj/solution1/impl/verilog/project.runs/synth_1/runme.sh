...
HD_PWD='/mnt/centos_share/Vivado_Tutorials/vivado_hls_tutorials/lesson_1/lesson_1_proj/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_adder.tcl
