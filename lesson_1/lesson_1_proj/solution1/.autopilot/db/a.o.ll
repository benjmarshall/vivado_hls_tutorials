; ModuleID = '/mnt/centos_share/Vivado_Tutorials/vivado_hls_tutorials/lesson_1/lesson_1_proj/solution1/.autopilot/db/a.o.bc'
...
define i32 @_Z12simple_adderii(i32 %a, i32 %b) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{i32* %c}, metadata !23), !dbg !25 ; [debug line = 2:6] [debug variable = c]
  %3 = load i32* %1, align 4, !dbg !26            ; [#uses=1 type=i32] [debug line = 3:2]
  %4 = load i32* %2, align 4, !dbg !26            ; [#uses=1 type=i32] [debug line = 3:2]
  %5 = add nsw i32 %3, %4, !dbg !26               ; [#uses=1 type=i32] [debug line = 3:2]
  store i32 %5, i32* %c, align 4, !dbg !26        ; [debug line = 3:2]
  %6 = load i32* %c, align 4, !dbg !27            ; [#uses=1 type=i32] [debug line = 4:2]
  ret i32 %6, !dbg !27                            ; [debug line = 4:2]
}
...
!23 = metadata !{i32 786688, metadata !24, metadata !"c", metadata !6, i32 2, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!24 = metadata !{i32 786443, metadata !5, i32 1, i32 32, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!25 = metadata !{i32 2, i32 6, metadata !24, null}
!26 = metadata !{i32 3, i32 2, metadata !24, null}
