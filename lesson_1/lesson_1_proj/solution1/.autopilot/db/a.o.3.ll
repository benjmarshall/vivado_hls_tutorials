; ModuleID = '/mnt/centos_share/Vivado_Tutorials/vivado_hls_tutorials/lesson_1/lesson_1_proj/solution1/.autopilot/db/a.o.3.bc'
...
define i32 @simple_adder(i32 %a, i32 %b) nounwind uwtable readnone {
  ...
  %c = add nsw i32 %b_read, %a_read, !dbg !34     ; [#uses=1 type=i32] [debug line = 3:2]
  call void @llvm.dbg.value(metadata !{i32 %c}, i64 0, metadata !36), !dbg !34 ; [debug line = 3:2] [debug variable = c]
  ret i32 %c, !dbg !37                            ; [debug line = 4:2]
}
...
!25 = metadata !{i32 786473, metadata !"source/dut.cpp", metadata !"/mnt/centos_share/Vivado_Tutorials/vivado_hls_tutorials/lesson_1", null} ; [ DW_TAG_file_type ]
...
!36 = metadata !{i32 786688, metadata !35, metadata !"c", metadata !25, i32 2, metadata !28, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!37 = metadata !{i32 4, i32 2, metadata !35, null}
