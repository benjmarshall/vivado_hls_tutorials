; ModuleID = '/mnt/centos_share/Vivado_Tutorials/vivado_hls_tutorials/lesson_1/lesson_1_proj/solution1/.autopilot/db/a.o.2.bc'
...
define i32 @simple_adder(i32 %a, i32 %b) nounwind uwtable readnone {
  ...
  %c = add nsw i32 %a, %b, !dbg !39               ; [#uses=1 type=i32] [debug line = 3:2]
  call void @llvm.dbg.value(metadata !{i32 %c}, i64 0, metadata !41), !dbg !39 ; [debug line = 3:2] [debug variable = c]
  ret i32 %c, !dbg !42                            ; [debug line = 4:2]
}
...
!39 = metadata !{i32 3, i32 2, metadata !40, null}
!40 = metadata !{i32 786443, metadata !5, i32 1, i32 32, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!41 = metadata !{i32 786688, metadata !40, metadata !"c", metadata !6, i32 2, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!42 = metadata !{i32 4, i32 2, metadata !40, null}
